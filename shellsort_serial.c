 ...
 * 
 * Code mostly generated by CoPilot AI, with some modifications. Ideas from
 * https://en.wikipedia.org/wiki/Shellsort for the gap sequence.
 * 
 * Compile with: gcc -Wall -O3 shellsort_serial.c -o shellsort_serial
